...
public class MoneyUtils {
	...
	private static String partner = "1230199602";// 微信支付商户号
	private static String partnerkey = "liu776392liu776392liu776392liu77";// 
	private static String charset = "UTF-8";
	//证书到商户系统下载
	final static String KEYSTORE_FILE = "C:/cert/apiclient_cert.p12";
	final static String KEYSTORE_PASSWORD = "1230199602";//默认证书密码是商户号
	  ...
	  public List xmlElements(String xmlDoc) {
	        ...
	        try {
	            ...
	            for(int i=0;i<jiedian.size();i++){
	                ...
	                System.out.println(et.getChild("result_code",ns).getText());
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public static String createSign2(Map<String, String> map) {
		SortedMap<String, String> packageParams = new TreeMap<String, String>();
