...
<html>
	...
	<body>
    	...
    	<s:iterator value="allyiji"> 
 		<!-- 内容 -->
        <div class="order" onclick="window.location='team!group1.action?teamyiji.id=<s:property value="id"/>'" style="background-color: white;height: 100px">
				        ...
				        <div  style="margin-top: 50px;float: right;margin-right: 15px"><img src="/../images/arrows-right.png" width="9" height="13" style="margin-top: -80px"></div>
		</div>	
