	...
	<script charset="utf-8" src="<%=request.getContextPath() %>/admin/kindeditor/lang/zh_CN.js"></script>
  	<script type="text/javascript">
		...
		KindEditor.ready(function(K) {
			editor = K.create('textarea[name="keyword.content"]', {
...
<s:if test="msg=='success'">
  <script >alert("添加成功")</script>
   ...
   <s:if test="msg=='fail'">
  <script >alert("添加失败，稍后再试")</script>
   </s:if> 
   
<c:import url="/admin/topmenu.jsp"></c:import>
<SCRIPT type="text/javascript">showwhere(2,4,"添加规则关键字回复规则")</SCRIPT>
<div class="admin">

    <div class="panel">
  <div class="panel-head"><strong>添加关键字回复规则</strong></div>
  <div class="panel-body">
  
<form action="keyword!add.action" id="form" method="post" enctype="multipart/form-data" >
                
                <div class="form-group">
                    <div class="label"><label for="sitename">标题</label></div>
                    <div class="field">
                    	<input type="text" class="input" id="sitename" name="keyword.title" size="50" placeholder="请输入标题" data-validate="required:请输入标题" />
                    </div>
                </div>
                    ...
                    <div class="field">
                    	<textarea rows="5" class="input" name="keyword.miaoshu" placeholder="请输入描述" data-validate="required:请输入描述"></textarea>
                    </div>
                </div>
                
                   <div class="form-group">
                    <div class="label"><label for="bianma">关键词</label></div>
                    <div class="field">
                    	<input type="text" class="input" id="bianma" value="" name="keyword.keyword" placeholder="请输入关键词" size="50" data-validate="required:请输入关键词"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="field">
                    	<textarea name="keyword.content" class="input" rows="20" cols="50"  ></textarea>
                    </div>
                </div>
