...
<div class="admin">
    ...
    <div class="panel">
  <div class="panel-head"><strong>修改关键字回复规则</strong></div>
  <div class="panel-body">
  
<form action="keyword!update1.action" id="form" method="post" enctype="multipart/form-data" >
                
                <div class="form-group">
                    <div class="label"><label for="sitename">标题</label></div>
                    <div class="field">
                    	<input type="text" class="input" id="sitename" name="keyword.title" value="${keyword.title}" size="50" placeholder="请输入标题" data-validate="required:请输入标题" />
                    </div>
                </div>
                    ...
                    <div class="field">
                    	<textarea rows="5" class="input" name="keyword.miaoshu"  placeholder="请输入描述" data-validate="required:请输入描述">${keyword.miaoshu}</textarea>
                    </div>
                </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="field">
                    	<input type="text" class="input" id="bianma"  name="keyword.keyword" value="${keyword.keyword}" placeholder="请输入关键词" size="50" data-validate="required:请输入关键词"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="field">
                    	<textarea name="keyword.content" class="input" rows="20" cols="50"  >${keyword.content}</textarea>
                    </div>
                </div>
