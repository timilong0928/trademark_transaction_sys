...
<%@ page import="java.util.*,java.io.*"%> 
    ...
    <%  
        ...
        String fileFileName=DateUtil.getfileName();
        fileFileName=fileFileName.substring(0,fileFileName.lastIndexOf("/"))+"/";  
        String savePath = "C:/l9lqjy/"+fileFileName;
        
        //文件保存目录URL /zswz/attached/  
        String saveUrl = request.getContextPath() + "/upload/"+fileFileName;
        //定义允许上传的文件扩展名  
        ...
        //imgFile
        //获得文件过滤器  
        File file = (File)wrapper.getFiles("imgFile")[0];  
        //检查扩展名  
