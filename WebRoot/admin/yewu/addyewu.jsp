		...
		<div class="admin">
			...
			<div class="panel">
				...
				<div class="panel-body">
					...
					<form name="form" action="yewu!add.action" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="field">
								<input type="text" class="input" id="sitename" name="yewu.price" size="50"
									placeholder="请输入" data-validate="required:请填写"/>
							</div>
						</div>
					...
					<div class="field">
						<div id="picture" class="field" style="width: 100%; ">
		                       ...
		                       <div id="scan0" class="fieldpic" style="width: 100%;float: left;" >
		                    	...
		                    	<input  onchange="preview(0,this,0)" size="100" style="" type="file" name="files" multiple
		                    	data-validate="required:请选择上传文件,regexp#.+.(jpg|jpeg|png|gif)$:只能上传jpg|gif|png格式文件" /></a>
		                       </div>
