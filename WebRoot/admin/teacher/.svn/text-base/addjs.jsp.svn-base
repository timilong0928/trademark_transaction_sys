		...
		<div class="admin">
			...
			<div class="panel">
				...
				<div class="panel-body">
					...
					<form action="teacher!add.action" id="form" method="post" enctype="multipart/form-data">
						<div class="form-group">
							...
							<div class="field">
								<input type="text" class="input" id="sitename" name="teacher.name" size="50"
						...
						<div class="form-group">
							...
							<div class="field">
								<textarea name="teacher.detail" class="input" rows="5" cols="10"></textarea>
							</div>
