...
<html lang="zh-cn">
	...
	<body>
		...
		<SCRIPT type="text/javascript">showwhere("articletop",1)</SCRIPT>
		<div class="admin">
			...
			<div class="panel">
				...
				<div class="panel-body">
					...
					<form name="form" action="article!add.action" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="field">
								<input type="text" class="input" id="sitename" name="article.title" size="50"
