		...
		<div class="admin">
			...
			<div class="panel">
				...
				<div class="panel-body">
					...
					<form name="form" action="article!gengxin.action" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="field">
								<input type="text" class="input" id="sitename" name="article.title" size="50" value="${article.title}"/>
							</div>
						</div>
