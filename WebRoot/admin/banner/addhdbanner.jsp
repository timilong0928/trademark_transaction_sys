		...
		<div class="admin">
			...
			<div class="panel">
				...
				<div class="panel-body">
					...
					<form name="form" action="banner!hdadd.action" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="field">
								<input type="text" class="input" id="sitename" name="banner.hdtitle" size="50"
						...
						<div class="form-group">
							...
							<div class="field">
								<input type="text" class="input" id="sitename" name="banner.hdMoney" size="50" 
						...
						<div class="form-group">
							...
							<div class="field">
							<input name="banner.hdtime" id="startTime" type="text" class="input input-auto" size="35"
										onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'%y-%M-%d %H:%m:%s'})"
										placeholder="请输入截止时间" data-validate="required:请填写时间"/>
						...
						<div class="form-group">
							...
							<div class="field" >
								<textarea name="banner.hdcontent" class="input"  id="sitename"
									style="height: 500px"  placeholder="请输 入介绍详情" ></textarea>
							</div>
						</div>
