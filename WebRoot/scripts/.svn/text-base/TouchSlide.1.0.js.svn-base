...
var TouchSlide = function(a) {
	...
	switch (i) {
	case "left":
		m.style.cssText = "width:" + n * M + "px;" + "position:relative;padding:0;margin:0;";
		for (var Q = 0; n > Q; Q++) m.children[Q].style.cssText = "float:left;width:" + N + "px;";
		e(m, '<div class="tempWrap" style=" position:relative; width:' + M + 'px"></div>');
		break;
	case "leftLoop":
		m.appendChild(m.children[0].cloneNode(!0)), m.insertBefore(m.children[n - 1].cloneNode(!0), m.children[0]), m.style.cssText = "width:" + (n + 2) * M + "px;" + "position:relative;padding:0;margin:0;";
	...
	var W = function() {
		...
		$ = function(a) {
			switch (i) {
			case "left":
				r >= p ? r = a ? r - 1 : 0 : 0 > r && (r = a ? 0 : p - 1), null != q && Y(0), Z(-r * M, s), x = r;
				break;
			case "leftLoop":
				null != q && Y(0), Z(-(r + 1) * M, s), -1 == r ? (z = setTimeout(function() {
					Z(-p * M, 0)
	...
	var _ = function(a) {
			...
			B = b.pageX, C = b.pageY, m.addEventListener(J, ab, !1), m.addEventListener(K, bb, !1)
		},
		ab = function(a) {
			if (!H || !(a.touches.length > 1 || a.scale && 1 !== a.scale)) {
				...
				if (D = b.pageX - B, E = b.pageY - C, O === void 0 && (O = !! (O || Math.abs(D) < Math.abs(E))), !O) {
					...
					case "left":
						(0 == r && D > 0 || r >= p - 1 && 0 > D) && (D = .4 * D), Z(-r * M + D, 0);
						break;
					case "leftLoop":
						Z(-(r + 1) * M + D, 0)
					}
